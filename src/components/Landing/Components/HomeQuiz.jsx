...
//                 <div className="content">
//                   <h6>Quizzes</h6>
//                   <h2 className="fw-bold">Try out Our Quizzes</h2>
//                   <p>See what you know about the forces changing the planet. Everyone can make a difference. Test yourself on some of the best options to do good work</p>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//                 <span>1</span>
//               </div>
//               <h4 className="appie-title"><Link to="/climate-change-quiz">Climate Change Quiz</Link></h4>
...
//                 <span>2</span>
//               </div>
//               <h4 className="appie-title"><Link to="/clean-energy-quiz">Clean Energy Quiz</Link></h4>
//               <p>Mucker plastered bugger all mate morish are.</p>
//             </div>
//           </div>
//           <div className="col-lg-3 col-md-6">
...
//                 <span>3</span>
//               </div>
//               <h4 className="appie-title"><Link to="/plastics-impacts-quiz">Plastics Impacts Quiz</Link></h4>
//               <p>Mucker plastered bugger all mate morish are.</p>
//             </div>
//           </div>
//           <div className="col-lg-3 col-md-6">
...
//                 <span>4</span>
//               </div>
//               <h4 className="appie-title"><Link to="/environmental-literacy-quiz">Environmental Literacy Quiz</Link></h4>
//               <p>Mucker plastered bugger all mate morish are.</p>
//             </div>
//           </div>
//         </div>
